...
export const fragmentSource = `
  ...
  void main() {
    ...
    // Extraer valor de lluvia de ambas texturas
    float rainNormCurrent = sampleBilinear(lon, lat, u_rain_data);
    float rainNormNext = sampleBilinear(lon, lat, u_rain_data_next);
