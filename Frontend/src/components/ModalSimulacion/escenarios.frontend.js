/**
 * escenarios.frontend.js — Catálogo fallback de escenarios para el frontend.
 * 
 * Sincronizado con escenarios.data.js.
 */

const escenariosFrontend = [
  // ─────────────────────────────────────────────────────────────
  // 01 · TEMPERATURA
  // ─────────────────────────────────────────────────────────────
  {
...
export default escenariosFrontend;
